...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.CLEAR_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.WHITE_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_GRAY_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.GRAY_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.BLACK_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.BROWN_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.RED_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.ORANGE_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.YELLOW_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.LIME_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.GREEN_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.CYAN_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.LIGHT_BLUE_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.BLUE_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.PURPLE_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.MAGENTA_GLASS_PIPE_BLOCK.get());
        dropSelf(ModBlocks.PINK_GLASS_PIPE_BLOCK.get());
        ...
        dropSelf(ModBlocks.CLEAR_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.WHITE_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.LIGHT_GRAY_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.GRAY_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.BLACK_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.BROWN_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.RED_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.ORANGE_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.YELLOW_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.LIME_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.GREEN_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.CYAN_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.LIGHT_BLUE_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.BLUE_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.PURPLE_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.MAGENTA_GLASS_PIPE_BODY.get());
        dropSelf(ModBlocks.PINK_GLASS_PIPE_BODY.get());
