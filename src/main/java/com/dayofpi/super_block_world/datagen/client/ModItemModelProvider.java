...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        blockItem(ModBlocks.CLEAR_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.WHITE_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.LIGHT_GRAY_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.GRAY_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.BLACK_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.BROWN_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.RED_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.ORANGE_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.YELLOW_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.LIME_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.GREEN_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.CYAN_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.LIGHT_BLUE_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.BLUE_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.PURPLE_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.MAGENTA_GLASS_PIPE_BLOCK);
        blockItem(ModBlocks.PINK_GLASS_PIPE_BLOCK);
        ...
        blockItem(ModBlocks.CLEAR_GLASS_PIPE_BODY);
        blockItem(ModBlocks.WHITE_GLASS_PIPE_BODY);
        blockItem(ModBlocks.LIGHT_GRAY_GLASS_PIPE_BODY);
        blockItem(ModBlocks.GRAY_GLASS_PIPE_BODY);
        blockItem(ModBlocks.BLACK_GLASS_PIPE_BODY);
        blockItem(ModBlocks.BROWN_GLASS_PIPE_BODY);
        blockItem(ModBlocks.RED_GLASS_PIPE_BODY);
        blockItem(ModBlocks.ORANGE_GLASS_PIPE_BODY);
        blockItem(ModBlocks.YELLOW_GLASS_PIPE_BODY);
        blockItem(ModBlocks.LIME_GLASS_PIPE_BODY);
        blockItem(ModBlocks.GREEN_GLASS_PIPE_BODY);
        blockItem(ModBlocks.CYAN_GLASS_PIPE_BODY);
        blockItem(ModBlocks.LIGHT_BLUE_GLASS_PIPE_BODY);
        blockItem(ModBlocks.BLUE_GLASS_PIPE_BODY);
        blockItem(ModBlocks.PURPLE_GLASS_PIPE_BODY);
        blockItem(ModBlocks.MAGENTA_GLASS_PIPE_BODY);
        blockItem(ModBlocks.PINK_GLASS_PIPE_BODY);
