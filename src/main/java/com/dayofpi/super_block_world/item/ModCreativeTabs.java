...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MAIN = CREATIVE_MODE_TABS.register("main", () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.POWER_STAR.get())).title(Component.translatable("itemGroup.super_block_world")).displayItems((itemDisplayParameters, output) -> {
        ...
        output.accept(ModItems.CLEAR_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.WHITE_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.LIGHT_GRAY_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.GRAY_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.BLACK_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.BROWN_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.RED_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.ORANGE_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.YELLOW_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.LIME_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.GREEN_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.CYAN_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.LIGHT_BLUE_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.BLUE_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.PURPLE_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.MAGENTA_GLASS_PIPE_BLOCK.get());
        output.accept(ModItems.PINK_GLASS_PIPE_BLOCK.get());
        ...
        output.accept(ModItems.CLEAR_GLASS_PIPE_BODY.get());
        output.accept(ModItems.WHITE_GLASS_PIPE_BODY.get());
        output.accept(ModItems.LIGHT_GRAY_GLASS_PIPE_BODY.get());
        output.accept(ModItems.GRAY_GLASS_PIPE_BODY.get());
        output.accept(ModItems.BLACK_GLASS_PIPE_BODY.get());
        output.accept(ModItems.BROWN_GLASS_PIPE_BODY.get());
        output.accept(ModItems.RED_GLASS_PIPE_BODY.get());
        output.accept(ModItems.ORANGE_GLASS_PIPE_BODY.get());
        output.accept(ModItems.YELLOW_GLASS_PIPE_BODY.get());
        output.accept(ModItems.LIME_GLASS_PIPE_BODY.get());
        output.accept(ModItems.GREEN_GLASS_PIPE_BODY.get());
        output.accept(ModItems.CYAN_GLASS_PIPE_BODY.get());
        output.accept(ModItems.LIGHT_BLUE_GLASS_PIPE_BODY.get());
        output.accept(ModItems.BLUE_GLASS_PIPE_BODY.get());
        output.accept(ModItems.PURPLE_GLASS_PIPE_BODY.get());
        output.accept(ModItems.MAGENTA_GLASS_PIPE_BODY.get());
        output.accept(ModItems.PINK_GLASS_PIPE_BODY.get());
