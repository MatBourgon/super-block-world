...
public class ModItems {
    ...
    public static final RegistryObject<Item> CLEAR_GLASS_PIPE_BLOCK = registerBlockItem("clear_glass_pipe", ModBlocks.CLEAR_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> WHITE_GLASS_PIPE_BLOCK = registerBlockItem("white_glass_pipe", ModBlocks.WHITE_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> LIGHT_GRAY_GLASS_PIPE_BLOCK = registerBlockItem("light_gray_glass_pipe", ModBlocks.LIGHT_GRAY_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> GRAY_GLASS_PIPE_BLOCK = registerBlockItem("gray_glass_pipe", ModBlocks.GRAY_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> BLACK_GLASS_PIPE_BLOCK = registerBlockItem("black_glass_pipe", ModBlocks.BLACK_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> BROWN_GLASS_PIPE_BLOCK = registerBlockItem("brown_glass_pipe", ModBlocks.BROWN_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> RED_GLASS_PIPE_BLOCK = registerBlockItem("red_glass_pipe", ModBlocks.RED_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> ORANGE_GLASS_PIPE_BLOCK = registerBlockItem("orange_glass_pipe", ModBlocks.ORANGE_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> YELLOW_GLASS_PIPE_BLOCK = registerBlockItem("yellow_glass_pipe", ModBlocks.YELLOW_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> LIME_GLASS_PIPE_BLOCK = registerBlockItem("lime_glass_pipe", ModBlocks.LIME_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> GREEN_GLASS_PIPE_BLOCK = registerBlockItem("green_glass_pipe", ModBlocks.GREEN_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> CYAN_GLASS_PIPE_BLOCK = registerBlockItem("cyan_glass_pipe", ModBlocks.CYAN_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> LIGHT_BLUE_GLASS_PIPE_BLOCK = registerBlockItem("light_blue_glass_pipe", ModBlocks.LIGHT_BLUE_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> BLUE_GLASS_PIPE_BLOCK = registerBlockItem("blue_glass_pipe", ModBlocks.BLUE_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> PURPLE_GLASS_PIPE_BLOCK = registerBlockItem("purple_glass_pipe", ModBlocks.PURPLE_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> MAGENTA_GLASS_PIPE_BLOCK = registerBlockItem("magenta_glass_pipe", ModBlocks.MAGENTA_GLASS_PIPE_BLOCK);
    public static final RegistryObject<Item> PINK_GLASS_PIPE_BLOCK = registerBlockItem("pink_glass_pipe", ModBlocks.PINK_GLASS_PIPE_BLOCK);
    ...
    public static final RegistryObject<Item> CLEAR_GLASS_PIPE_BODY = registerBlockItem("clear_glass_pipe_body", ModBlocks.CLEAR_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> WHITE_GLASS_PIPE_BODY = registerBlockItem("white_glass_pipe_body", ModBlocks.WHITE_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> LIGHT_GRAY_GLASS_PIPE_BODY = registerBlockItem("light_gray_glass_pipe_body", ModBlocks.LIGHT_GRAY_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> GRAY_GLASS_PIPE_BODY = registerBlockItem("gray_glass_pipe_body", ModBlocks.GRAY_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> BLACK_GLASS_PIPE_BODY = registerBlockItem("black_glass_pipe_body", ModBlocks.BLACK_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> BROWN_GLASS_PIPE_BODY = registerBlockItem("brown_glass_pipe_body", ModBlocks.BROWN_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> RED_GLASS_PIPE_BODY = registerBlockItem("red_glass_pipe_body", ModBlocks.RED_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> ORANGE_GLASS_PIPE_BODY = registerBlockItem("orange_glass_pipe_body", ModBlocks.ORANGE_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> YELLOW_GLASS_PIPE_BODY = registerBlockItem("yellow_glass_pipe_body", ModBlocks.YELLOW_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> LIME_GLASS_PIPE_BODY = registerBlockItem("lime_glass_pipe_body", ModBlocks.LIME_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> GREEN_GLASS_PIPE_BODY = registerBlockItem("green_glass_pipe_body", ModBlocks.GREEN_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> CYAN_GLASS_PIPE_BODY = registerBlockItem("cyan_glass_pipe_body", ModBlocks.CYAN_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> LIGHT_BLUE_GLASS_PIPE_BODY = registerBlockItem("light_blue_glass_pipe_body", ModBlocks.LIGHT_BLUE_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> BLUE_GLASS_PIPE_BODY = registerBlockItem("blue_glass_pipe_body", ModBlocks.BLUE_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> PURPLE_GLASS_PIPE_BODY = registerBlockItem("purple_glass_pipe_body", ModBlocks.PURPLE_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> MAGENTA_GLASS_PIPE_BODY = registerBlockItem("magenta_glass_pipe_body", ModBlocks.MAGENTA_GLASS_PIPE_BODY);
    public static final RegistryObject<Item> PINK_GLASS_PIPE_BODY = registerBlockItem("pink_glass_pipe_body", ModBlocks.PINK_GLASS_PIPE_BODY);
